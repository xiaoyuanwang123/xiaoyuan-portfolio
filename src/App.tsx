    ...
    <div className="font-sans">
      ...
      <div className="p-6 md:p-10">
        ...
        <div className="flex gap-3 mb-4">
          ...
          <a href="https://github.com/xiaoyuanwang123/yangyang-london/raw/main/index.html" download="london-tour.html" className="text-[11px] text-ink/40 underline mt-1 block">{lang === "zh" ? "无法访问？下载离线版本" : "Can't access? Download offline version"}</a>
        </div>
    ...
    <div className="font-sans">
      ...
      <div className="p-6 md:p-10">
        ...
        <div className="flex gap-3 mb-4">
          ...
          <a href="https://github.com/xiaoyuanwang123/monopoly-tool/raw/main/index.html" download="monopoly-tool.html" className="text-[11px] text-ink/40 underline mt-1 block">{lang === "zh" ? "无法访问？下载离线版本" : "Can't access? Download offline version"}</a>
        </div>
        <div className="flex items-center gap-3 my-4">
          <span className="text-[10px] font-black uppercase tracking-widest text-ink/30 whitespace-nowrap">AI PM 工作流分析</span>
          <div className="h-px flex-1 bg-ink/10" />
