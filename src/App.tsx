...
const translations = {
  zh: {
    ...
    aboutTitle: "教育背景",
    viewMore: "查看详情",
    aboutText: "从 AI 情感依赖到辅助工具包，这些项目让我看到：好的设计不是给出答案，而是帮人找到自己的路。建筑、行为科学、AI 研究——这些构成了我的思考方式。研究与设计的交叉，是我的语言。",
                ...
                {schools.map((school, i) => (
                  ...
                  >
                    <div className="relative h-40 overflow-hidden rounded-lg mb-4">
                      ...
                      {i === schools.length - 1 && (
                        <div className="absolute top-2 right-2 w-8 h-8 bg-terracotta text-paper rounded-full flex items-center justify-center border border-ink shadow-sm rotate-12 font-serif font-black text-sm z-10">W</div>
                      )}
                    </div>
